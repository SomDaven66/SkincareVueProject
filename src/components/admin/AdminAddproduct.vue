...
<template>
  <div class="min-h-screen bg-[#F9FBF7] text-[#0F3D2E]">
    ...
    >
      <div
        class="mx-auto flex h-20 max-w-6xl items-center justify-between px-4 sm:px-6"
      >
        <div class="flex items-center gap-4">
          <button
            type="button"
            @click="goBack"
            class="flex h-10 w-10 items-center justify-center rounded-xl border border-[#DCE6DC] text-[#0F3D2E] transition hover:bg-[#F4F8F1]"
          >
            <ArrowLeft :size="19" />
          </button>
        ...
        <div
          class="hidden h-10 w-10 items-center justify-center rounded-full bg-[#F4F8F1] sm:flex"
        >
          <Package
            :size="20"
            class="text-[#0F3D2E]"
