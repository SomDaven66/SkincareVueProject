  ...
  <div class="mx-auto max-w-4xl">
    ...
    <div class="mb-8">
      ...
      <div>
        ...
        <h1 class="mt-2 text-3xl font-bold text-[#0F3D2E] sm:text-4xl">
          Edit Profile
        </h1>
      ...
      <div class="bg-[#F4F8F1] px-6 py-8 sm:px-8">
        ...
        >
          ...
          <div class="text-center sm:text-left">
            ...
            <span
              class="mt-2 inline-block rounded-full bg-[#0F3D2E] px-3 py-1 text-xs font-semibold text-white"
            >
              ADMIN
            </span>
          </div>
    ...
    >
      ...
      <div class="mb-7">
        ...
        <h2 class="mt-1 text-2xl font-bold text-[#0F3D2E]">
          Personal Information
        </h2>

        <p class="mt-2 text-sm text-gray-500">
          Keep your admin account information up to date.
        </p>
      </div>
...
const saveChanges = () => {
  ...
  if (
    ...
    if (
      passwordForm.value.currentPassword !== currentUser.value.password
    ) {
  ...
  // Save to adminUser key
  localStorage.setItem("adminUser", JSON.stringify(currentUser.value));
