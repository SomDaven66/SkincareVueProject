...
<template>
  <div class="min-h-screen bg-[#F9FBF7] text-[#0F3D2E]">
    ...
    >
      ...
      <div
        class="flex h-20 items-center border-b border-[#DCE6DC] px-6"
      >
        <div>
          <h1
            class="text-2xl font-bold tracking-wide text-[#0F3D2E]"
          >
            Lumie
          </h1>

          <p
            class="text-[10px] font-semibold tracking-[0.3em] text-[#7A9E7E]"
          >
            SKIN ADMIN
          </p>
        </div>
      ...
      <nav class="space-y-2 px-4 py-6">
        ...
        <router-link
          to="/admin/dashboard"
          class="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-medium text-gray-600 transition hover:bg-[#F4F8F1] hover:text-[#0F3D2E]"
        >
        ...
        <router-link
          to="/admin/product"
          class="flex items-center gap-3 rounded-xl bg-[#0F3D2E] px-4 py-3 text-sm font-medium text-white"
        >
          <Package :size="20" />
          Products
        </router-link>
      ...
      <div
        class="absolute bottom-0 left-0 right-0 border-t border-[#DCE6DC] p-4"
      >
        <router-link
          to="/admin/profile"
          class="flex items-center gap-3 rounded-xl p-3 transition hover:bg-[#F4F8F1]"
        >
          <div
            class="flex h-10 w-10 items-center justify-center rounded-full bg-[#A8C3A0]"
          >
            <UserRound
              :size="20"
              class="text-[#0F3D2E]"
    ...
    <main class="lg:ml-64">
      ...
      <header
        class="sticky top-0 z-30 border-b border-[#DCE6DC] bg-white/95 backdrop-blur-md"
      >
        <div
        ...
        >
          ...
          <div>
            <h2
              class="text-xl font-bold text-[#0F3D2E] sm:text-2xl"
            >
              Products
            </h2>
          ...
          >
            <div
              class="flex h-10 w-10 items-center justify-center rounded-full border-2 border-[#A8C3A0] bg-[#F4F8F1]"
            >
              <UserRound
                :size="19"
                class="text-[#0F3D2E]"
