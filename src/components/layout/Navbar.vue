...
<template>
  ...
  >
    <div
      class="mx-auto flex h-22 max-w-7xl items-center justify-between px-6"
    >
        ...
        <!-- Add to card -->
         ...
         >
          ...
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
            d="M3 4h2l2.4 11.2a2 2 0 0 0 2 1.6h7.8
              a2 2 0 0 0 1.9-1.4L21 8H6"
          />
             <!-- Wheels -->
              <circle
                cx="10"
