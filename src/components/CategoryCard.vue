    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="mb-12 text-center">
        ...
        <p class="mt-3 text-sm max-w-xl mx-auto md:text-base" style="color: #7A9E7E;">
          Find the right routine, from cleansing to hydration, tailored to your skin's needs.
        </p>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
        ...
        >
          ...
          <div class="flex flex-col items-center flex-1 px-4 py-5">
            <h3 class="text-sm md:text-base font-semibold mb-1" style="color: #0F3D2E;">
              {{ catego.name }}
            </h3>
            ...
            <span
              ...
              :style="{
                ...
                backgroundColor: hoveredId === catego.id ? '#174A3A' : '#A8C3A0',
              }"
