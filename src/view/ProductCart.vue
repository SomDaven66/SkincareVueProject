  ...
  <div class="min-h-screen bg-[#F9FBF7]">
    ...
    >
      ...
      <div class="mx-auto max-w-7xl text-center relative">
        <p class="mb-3 text-xs font-semibold text-[#7A9E7E] uppercase tracking-[0.3em]">
          Curated Skincare Collection
        </p>

        <h1 class="text-4xl font-bold text-[#0F3D2E] tracking-tight sm:text-5xl lg:text-6xl">
          Our Products
        </h1>
    ...
    <div class="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <!-- Search & Sort Row -->
      <div class="flex-col mb-6 gap-4 flex sm:flex-row sm:items-center sm:justify-between">
        <!-- Search Bar -->
        <div class="w-full relative sm:max-w-md">
          <Search
            class="h-4 w-4 text-[#9AAD9A] top-1/2 absolute left-4 -translate-y-1/2"
            :stroke-width="2"
          />
          <input
            v-model="searchQuery"
          ...
          <div class="flex-1 flex-col p-5 justify-between flex">
            <div>
              ...
              <div class="mb-2 justify-between flex items-center">
                <span class="px-2 py-1 rounded-md bg-[#F4F8F1] text-[11px] font-semibold text-[#7A9E7E] uppercase tracking-wider">
                  {{ item.category }}
                </span>
              ...
              <RouterLink :to="`/products/${item.id}`">
                <h3 class="mb-1 text-[15px] font-bold text-[#0F3D2E] leading-snug transition-colors group-hover:text-[#174A3A]">
                  {{ item.name }}
                </h3>
              </RouterLink>
            ...
            <!-- Price + CTA -->
            <div class="mt-4 pt-4 justify-between border-t border-[#EAF2E9] flex items-center">
      ...
      >
        <div class="mb-5 mx-auto h-20 w-20 justify-center rounded-full bg-[#F4F8F1] flex items-center">
